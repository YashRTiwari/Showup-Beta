    ...
    return (
        <>
            ...
            <div className="join-room-header" >
                ...
                <Button variant="contained" color="secondary" onClick={onMeetingEnd}>Exit</Button>
            </div>
            ...
            <div className="JoinRoom">
                        ...
                        <div className="join-room-cues">
                            ...
                            <IconButton onClick={(e) => handleCueUpDown(-1)} size="small" style={{backgroundColor: "#4682B4"}}  color="primary" aria-label="upload picture" component="span">
                                <MoveUpIcon  htmlColor="#fff" />
                            </IconButton>

                            <CueCard  readOnly={true}  data={roomData.cueCards[selectedCueIndex]} />

                            <IconButton onClick={(e) => handleCueUpDown(1)} size="small" style={{backgroundColor: "#4682B4"}} color="primary" >
            ...
            <div className="join-room-details">
